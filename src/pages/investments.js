  ...
  const renderTable = (data) => {
      ...
      tbody.innerHTML = data.map(r => {
        ...
        <tr>
          ...
          <td>
            <button class="btn-action" onclick="window.editInvestment(${r.id})">
              <svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg>
              Editar
            </button>
            <button class="btn-action btn-action--danger" onclick="window.deleteInvestment(${r.id})">
      ...
      <div class="modal-content">
        ...
        <form id="formInvestment" data-id="">
          ...
          <div class="modal-actions">
            <button type="button" id="btnCancelInv" class="btn btn-secondary">Cancelar</button>
